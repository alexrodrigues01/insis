...
//                .antMatchers(HttpMethod.GET, "/reviews/pending").hasRole(Role.Mod)
//                .antMatchers(HttpMethod.GET, "/reviews/**").hasRole(Role.RegisteredUser)
                .antMatchers(HttpMethod.GET, "/admin/user/**").permitAll()
                .antMatchers(HttpMethod.GET, "/reviews/pending").permitAll()
