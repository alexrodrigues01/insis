...
import isep.insis.reviews.model.Role;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/products/**/reviews").hasRole(Role.RegisteredUser)
                .antMatchers(HttpMethod.DELETE, "/reviews/**").hasRole(Role.RegisteredUser)
                .antMatchers(HttpMethod.PUT,"/reviews/acceptreject/**").hasRole(Role.Mod)
//                .antMatchers(HttpMethod.POST, "/products/***/reviews").permitAll()
//                .antMatchers(HttpMethod.DELETE, "/reviews/**").permitAll()
//                .antMatchers(HttpMethod.PUT,"/reviews/acceptreject/**").permitAll()
